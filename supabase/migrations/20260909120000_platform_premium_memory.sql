...
create or replace function public.complete_memory_card(p_user_id uuid, p_completion_id uuid, p_card_id text, p_rating text, p_xp integer, p_daily_limit integer)
...
revoke all on function public.complete_memory_card(uuid,uuid,text,text,integer,integer) from public, anon, authenticated;
grant execute on function public.complete_memory_card(uuid,uuid,text,text,integer,integer) to service_role;
