...
export default function WordOfTheDay({ embedded = false }: { embedded?: boolean }) {
  ...
  const content = <Paper component="section" variant="outlined" sx={{ p: { xs: 3, md: 4 }, borderRadius: '16px' }}>
  ...
  return embedded ? content : <Container maxWidth="lg" sx={{ pt: 3 }}>{content}</Container>
}
